...
class GlobalConfig:
  ...
  def __init__(self):
    ...
    self.add_features = False  # Whether to add (true) or concatenate (false) the features at the end of the backbone.
    ...
    self.use_tp = False  # Whether to use the target point as input to TransFuser
    ...
    #self.reduce_straight_run_rate = None #rate for ignore low steer data
    #self.low_steer_threshold = None # Thewshold to detect straight run
    self.ignore_command = []
    self.MaskScoreCheck_for_Dataset = True
    self.steer_class_thresh = 0.1
    ...
    # PilotNet (manual add)
    #------------------------------------------------------------------------------
    self.use_PilotNet = True
    self.use_PilotNet_class = True
    self.PilotNet_H = 66
    self.PilotNet_W = 200
    self.PilotNet_image_std = 0.5
    self.PilotNet_image_mean = 0.5
    #------------------------------------------------------------------------------
    # CIL (manual add)
    #------------------------------------------------------------------------------
    self.use_CIL = False
    self.str_loss_weight = 1# Loss = weitht*loss_str + weitht*loss_throttle + weitht*loss_brake
    self.throttle_loss_weight = 0.1# Loss = weitht*loss_str + weitht*loss_throttle + weitht*loss_brake
    self.brake_loss_weight = 0# Loss = weitht*loss_str + weitht*loss_throttle + weitht*loss_brake
    self.CIL_H = 88
    self.CIL_W = 200
    self.num_image_out = 512
    self.num_measurement_out = 128
    self.CIL_image_std = 0.5
    self.CIL_image_mean = 0.5
    self.CIL_speed_std = 10
    self.CIL_speed_mean = 10
    #-------------------------------------------------
